...
export default defineConfig({
  shortcuts: [
    ['btn', 'px-4 py-1 rounded inline-block bg-indigo-500 text-white cursor-pointer hover:bg-indigo-600 disabled:cursor-default disabled:bg-gray-600 disabled:opacity-50'],
